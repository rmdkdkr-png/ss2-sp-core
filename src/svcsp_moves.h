...
static const svc_move mv_c0[] = {
  {"외식 굉부양 (Goufu You)", mo_c0_0, 1, 0x20, 8},
  {"88식", mo_c0_1, 1, 0x20, 8},
  {"외식 나락 떨구기 (Naraku Otoshi)", mo_c0_2, 1, 0x10, 4},
  {"114식 황물기 (Aragami)", mo_c0_3, 3, 0x10, 0},
  {"115식 독물기 (Dokugami)", mo_c0_4, 3, 0x10, 0},
  {"128식 구상 (Kono Kizu)", mo_c0_5, 3, 0x10, 8},
  {"127식 팔청 (Yano Sabi)", mo_c0_6, 5, 0x10, 8},
  {"401식 죄읊기 (Tsumi Yomi)", mo_c0_7, 5, 0x10, 8},
  {"100식 귀신태우기 (Oniyaki)", mo_c0_8, 3, 0x10, 0},
  {"R.E.D. 킥", mo_c0_9, 3, 0x20, 8},
  {"75식 개", mo_c0_10, 3, 0x20, 8},
  {"212식 금월양 (Kototsuki You)", mo_c0_11, 5, 0x20, 8},
  {"910식 누에잡기 (Nue Tsumi)", mo_c0_12, 3, 0x10, 0},
  {"이면 108식 대사치 (Orochinagi)", mo_c0_13, 7, 0x10, 8},
  {"최종결전오의 무식", mo_c0_14, 6, 0x10, 0},
  {"182식", mo_c0_15, 6, 0x20, 8},
};
...
static const svc_move mv_c1[] = {
  {"라이징 어퍼", mo_c1_0, 1, 0x10, 0},
  {"백스핀 킥", mo_c1_1, 1, 0x20, 8},
  {"파워 웨이브", mo_c1_2, 3, 0x10, 0},
  {"라이징 태클", mo_c1_3, 2, 0x10, 16},
  {"크랙 슛", mo_c1_4, 3, 0x20, 8},
  {"번 너클", mo_c1_5, 3, 0x10, 0},
  {"파워 덩크", mo_c1_6, 3, 0x20, 8},
  {"파이어 킥", mo_c1_7, 5, 0x20, 8},
  {"파워 가이저", mo_c1_8, 7, 0x10, 0},
  {"하이 앵글 가이저", mo_c1_9, 6, 0x20, 8},
};
...
static const svc_move mv_c2[] = {
  {"빙주할 (Hyouchuu Wari)", mo_c2_0, 1, 0x10, 0},
  {"호황권", mo_c2_1, 3, 0x10, 0},
  {"공중 호황권", mo_c2_2, 3, 0x10, 4},
  {"호포", mo_c2_3, 3, 0x10, 0},
  {"비연질풍각", mo_c2_4, 5, 0x20, 8},
  {"잔렬권", mo_c2_5, 3, 0x10, 0},
  {"패왕상후권", mo_c2_6, 6, 0x10, 8},
  {"용호난무", mo_c2_7, 7, 0x10, 8},
  {"천지패황권", mo_c2_8, 6, 0x10, 8},
};
...
static const svc_move mv_c3[] = {
  {"홍학의 춤 (Benitsuru no Mai)", mo_c3_0, 1, 0x20, 8},
  {"흑연의 춤 (Koku'en no Mai)", mo_c3_1, 1, 0x20, 8},
  {"대륜풍차떨구기", mo_c3_2, 1, 0x10, 4},
  {"화접선", mo_c3_3, 3, 0x10, 0},
  {"용염무", mo_c3_4, 3, 0x10, 0},
  {"사치요 도리 (小夜千鳥)", mo_c3_5, 3, 0x20, 8},
  {"필살인봉", mo_c3_6, 5, 0x20, 8},
  {"무사사비의 춤 (지상)", mo_c3_7, 2, 0x10, 16},
  {"무사사비의 춤 (공중)", mo_c3_8, 3, 0x10, 4},
  {"초필살인봉", mo_c3_9, 7, 0x20, 8},
  {"화람 (Hana Arashi)", mo_c3_10, 6, 0x10, 8},
  {"봉황의 춤", mo_c3_11, 6, 0x10, 0},
};
...
static const svc_move mv_c4[] = {
  {"스트라이크 아치", mo_c4_0, 1, 0x20, 8},
  {"발틱 런처", mo_c4_1, 2, 0x10, 16},
  {"그라운드 세이버", mo_c4_2, 2, 0x20, 24},
  {"문 슬래셔", mo_c4_3, 2, 0x10, 16},
  {"아이 슬래셔", mo_c4_4, 3, 0x10, 0},
  {"X 칼리버", mo_c4_5, 3, 0x10, 4},
  {"이어링 폭탄", mo_c4_6, 3, 0x20, 8},
  {"V 슬래셔", mo_c4_7, 7, 0x10, 12},
  {"리벨 스파크", mo_c4_8, 7, 0x20, 8},
  {"그래비티 스톰", mo_c4_9, 6, 0x10, 8},
  {"그레이트풀 데드", mo_c4_10, 6, 0x20, 8},
};
...
static const svc_move mv_c5[] = {
  {"연환퇴", mo_c5_0, 1, 0x20, 8},
  {"피닉스 밤", mo_c5_1, 1, 0x20, 12},
  {"사이코 볼", mo_c5_2, 3, 0x10, 0},
  {"사이코 소드", mo_c5_3, 3, 0x10, 0},
  {"피닉스 애로우", mo_c5_4, 3, 0x20, 12},
  {"사이코 리플렉터", mo_c5_5, 5, 0x20, 8},
  {"뉴(ν) 사이코 리플렉터", mo_c5_6, 5, 0x20, 8},
  {"사이킥 텔레포트", mo_c5_7, 3, 0x20, 8},
  {"슈퍼 사이킥 스로우", mo_c5_8, 5, 0x10, 1},
  {"샤이닝 크리스탈 비트", mo_c5_9, 10, 0x10, 8},
  {"피닉스 팽 애로우", mo_c5_10, 6, 0x20, 12},
  {"원조! 불꽃의 검 (Flame Sword)", mo_c5_11, 6, 0x10, 0},
};
...
static const svc_move mv_c6[] = {
  {"외식 유메비키 (꿈불기)", mo_c6_0, 1, 0x10, 0},
  {"외식 굉부음 '사신'", mo_c6_1, 1, 0x20, 8},
  {"외식 유리오리 (백합꺾기)", mo_c6_2, 1, 0x20, 12},
  {"108식 야미바라이 (어둠쫓기)", mo_c6_3, 3, 0x10, 0},
  {"100식 오니야키", mo_c6_4, 3, 0x10, 0},
  {"127식 아오이하나", mo_c6_5, 3, 0x10, 0},
  {"212식 코토츠키 인", mo_c6_6, 5, 0x20, 8},
  {"311식 츠마구시", mo_c6_7, 3, 0x20, 8},
  {"쿠즈카제", mo_c6_8, 6, 0x10, 9},
  {"금 1211식 야오토메 (팔치녀)", mo_c6_9, 7, 0x10, 8},
  {"이면 108식 야사카즈키", mo_c6_10, 7, 0x10, 8},
  {"이면 311식 사쿠 츠마구시", mo_c6_11, 6, 0x20, 8},
};
...
static const svc_move mv_c7[] = {
  {"오의 선풍열참", mo_c7_0, 3, 0x10, 0},
  {"오의 호월참", mo_c7_1, 3, 0x10, 0},
  {"오의 열진참", mo_c7_2, 3, 0x10, 0},
  {"비오의 천파봉신참", mo_c7_3, 6, 0x10, 0},
  {"비오의 천파단공열참", mo_c7_4, 6, 0x20, 8},
};
...
static const svc_move mv_c8[] = {
  {"카무이 훔 케습", mo_c8_0, 1, 0x20, 12},
  {"안누 무츠베", mo_c8_1, 3, 0x10, 0},
  {"레라 무츠베", mo_c8_2, 3, 0x10, 0},
  {"카무이 림세", mo_c8_3, 3, 0x10, 0},
  {"시치카푸 에투", mo_c8_4, 3, 0x10, 0},
  {"매에 매달리기 (타카니 츠카마루)", mo_c8_5, 3, 0x20, 8},
  {"엘레루시 카무이 림세", mo_c8_6, 6, 0x10, 0},
  {"이루스카 야토로 림세", mo_c8_7, 6, 0x20, 8},
};
...
static const svc_move mv_c9[] = {
  {"쇄골 부수기(Sakotsu Wari)", mo_c9_0, 1, 0x10, 0},
  {"선풍각(Senpukyaku)", mo_c9_1, 1, 0x20, 8},
  {"파동권(Hadouken)", mo_c9_2, 3, 0x10, 0},
  {"작열 파동권(Shakunetsu Hadouken)", mo_c9_3, 5, 0x10, 8},
  {"승룡권(Shoryuken)", mo_c9_4, 3, 0x10, 0},
  {"용권선풍각(Tatsumaki Senpukyaku)", mo_c9_5, 3, 0x20, 8},
  {"진공파동권(Shinku Hadouken)", mo_c9_6, 6, 0x10, 0},
  {"진공용권선풍각(Shinku Tatsumaki Senpukyaku)", mo_c9_7, 6, 0x20, 8},
  {"진 승룡권(Shin Shoryuken)", mo_c9_8, 6, 0x20, 8},
};
...
static const svc_move mv_c10[] = {
  {"학각락(Kaku Kyaku Raku)", mo_c10_0, 1, 0x10, 0},
  {"후방회전각(Kouhou Kaiten Kyaku)", mo_c10_1, 1, 0x20, 8},
  {"응조각(Yousou Kyaku)", mo_c10_2, 1, 0x20, 12},
  {"기공권(Kikoken)", mo_c10_3, 5, 0x10, 0},
  {"천승각(Tenshokyaku)", mo_c10_4, 2, 0x20, 24},
  {"스피닝 버드 킥(Spinning Bird Kick)", mo_c10_5, 2, 0x20, 24},
  {"선원추(Sen'enshu)", mo_c10_6, 5, 0x20, 8},
  {"기공장(Kikosho)", mo_c10_7, 6, 0x10, 8},
  {"천렬각(Senretsukyaku)", mo_c10_8, 4, 0x20, 24},
  {"패산천승각(Hazan Tenshokyaku)", mo_c10_9, 4, 0x20, 24},
  {"칠성섬공각(Shichisei Senkukyaku)", mo_c10_10, 6, 0x20, 12},
};
...
static const svc_move mv_c11[] = {
  {"헤드벗(Headbutt)", mo_c11_0, 1, 0x10, 0},
  {"다이너마이트 킥(Dynamite Kick)", mo_c11_1, 1, 0x20, 8},
  {"플라잉 바디 프레스(Flying Body Press)", mo_c11_2, 1, 0x10, 4},
  {"더블 니 드롭(Double Knee Drop)", mo_c11_3, 1, 0x20, 12},
  {"공중 헤드벗(Midair Headbutt)", mo_c11_4, 1, 0x10, 12},
  {"더블 라리아트(Double Lariat)", mo_c11_5, 3, 0x10, 0},
  {"퀵 더블 라리아트(Quick Double Lariat)", mo_c11_6, 3, 0x20, 8},
  {"배니싱 플랫(Banishing Flat)", mo_c11_7, 3, 0x10, 0},
  {"스크류 파일 드라이버(Screw Piledriver)", mo_c11_8, 6, 0x10, 1},
  {"아토믹 수플렉스(Atomic Suplex)", mo_c11_9, 6, 0x20, 9},
  {"플라잉 파워밤(Flying Powerbomb)", mo_c11_10, 6, 0x20, 8},
  {"파이널 아토믹 버스터(Final Atomic Buster)", mo_c11_11, 6, 0x10, 9},
  {"에어리얼 러시안 슬램(Aerial Russian Slam)", mo_c11_12, 6, 0x20, 8},
  {"러시안 비트(Russian Beat)", mo_c11_13, 6, 0x20, 8},
};
...
static const svc_move mv_c12[] = {
  {"이나즈마 카카토 와리(Inazuma Kakato Wari)", mo_c12_0, 1, 0x10, 0},
  {"우시로 마와시 게리(Ushiro Mawashi Geri)", mo_c12_1, 1, 0x20, 8},
  {"전방전신(Zenpou Tenshin)", mo_c12_2, 3, 0x10, 0},
  {"파동권(Hadouken)", mo_c12_3, 3, 0x10, 0},
  {"승룡권(Shoryuken)", mo_c12_4, 3, 0x10, 0},
  {"용권선풍각(Tatsumaki Senpukyaku)", mo_c12_5, 3, 0x20, 8},
  {"승룡열파(Shoryu Reppa)", mo_c12_6, 5, 0x10, 8},
  {"신룡권(Shinryuken)", mo_c12_7, 6, 0x20, 8},
  {"질풍신뢰각(Shippu Jinraikyaku)", mo_c12_8, 6, 0x20, 8},
};
...
static const svc_move mv_c13[] = {
  {"아도권(Gadouken)", mo_c13_0, 3, 0x10, 0},
  {"코류켄(Kouryuken)", mo_c13_1, 3, 0x10, 0},
  {"단공각(Dankukyaku)", mo_c13_2, 3, 0x20, 8},
  {"진공아도권(Shinku Gadouken)", mo_c13_3, 6, 0x10, 0},
  {"코류렉카(Kouryu Rekka)", mo_c13_4, 5, 0x20, 8},
  {"필승무뢰권(Hisshou Burai Ken)", mo_c13_5, 6, 0x20, 8},
  {"오토코미치(Otoko Michi)", mo_c13_6, 4, 0x10, 24},
};
...
static const svc_move mv_c14[] = {
  {"플라워 킥(Flower Kick)", mo_c14_0, 1, 0x20, 8},
  {"파동권(Hadouken)", mo_c14_1, 3, 0x10, 0},
  {"쇼오켄(Shououken)", mo_c14_2, 3, 0x10, 0},
  {"춘풍각(Shunpukyaku)", mo_c14_3, 3, 0x20, 8},
  {"사쿠라 오토시(Sakura Otoshi)", mo_c14_4, 3, 0x20, 8},
  {"진공파동권(Shinku Hadouken)", mo_c14_5, 6, 0x10, 0},
  {"미다레자쿠라(Midare Zakura)", mo_c14_6, 5, 0x20, 8},
  {"하루이치방(Haru Ichiban)", mo_c14_7, 6, 0x20, 8},
  {"슌고쿠사츠(Shun Goku Satsu)", mo_c14_8, 4, 0x10, 24},
};
...
static const svc_move mv_c15[] = {
  {"셸 킥(Shell Kick)", mo_c15_0, 1, 0x20, 12},
  {"소울 피스트(Soul Fist)", mo_c15_1, 3, 0x10, 0},
  {"섀도 블레이드(Shadow Blade)", mo_c15_2, 3, 0x10, 0},
  {"벡터 드레인(Vector Drain)", mo_c15_3, 5, 0x10, 1},
  {"다크니스 일루전(Darkness Illusion)", mo_c15_4, 6, 0x10, 0},
  {"피니싱 샤워(Finishing Shower)", mo_c15_5, 6, 0x20, 8},
  {"발키리 턴(Valkyrie Turn)", mo_c15_6, 5, 0x20, 8},
  {"크립틱 니들(Cryptic Needle)", mo_c15_7, 6, 0x10, 8},
};
...
static const svc_move mv_c16[] = {
  {"롤링 버클러(Rolling Buckler)", mo_c16_0, 3, 0x10, 0},
  {"캣 스파이크(Cat Spike)", mo_c16_1, 3, 0x10, 0},
  {"델타 킥(Delta Kick)", mo_c16_2, 3, 0x20, 8},
  {"헬 캣(Hell Cat)", mo_c16_3, 5, 0x20, 9},
  {"캣 클린치(Cat Clinch/Fake Throw)", mo_c16_4, 1, 0x10, 9},
  {"댄싱 플래시(Dancing Flash)", mo_c16_5, 6, 0x10, 0},
  {"플리즈 헬프 미(Please Help Me)", mo_c16_6, 6, 0x10, 8},
  {"ES 롤링 스크래치(ES Rolling Scratch)", mo_c16_7, 6, 0x20, 8},
};
...
static const svc_move mv_c17[] = {
  {"스피닝 백 너클(Spinning Back Knuckle)", mo_c17_0, 1, 0x10, 0},
  {"리버스 스핀 킥(Reverse Spin Kick)", mo_c17_1, 1, 0x20, 8},
  {"소닉 붐(Sonic Boom)", mo_c17_2, 2, 0x10, 16},
  {"서머솔트 킥(Somersault Kick)", mo_c17_3, 2, 0x20, 24},
  {"소닉 허리케인(Sonic Hurricane)", mo_c17_4, 4, 0x10, 24},
  {"서머솔트 스트라이크(Somersault Strike)", mo_c17_5, 4, 0x20, 24},
  {"크로스파이어 블리츠(Crossfire Blitz)", mo_c17_6, 4, 0x20, 24},
};
