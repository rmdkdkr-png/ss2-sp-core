...
struct retro_core_option_v2_definition option_defs_us_v2[] = {
   ...
   },
   {
      ...
      NULL,
      "월화의 검사(The Last Blade) 전용. 켜면 R가 기술키가 됩니다. 끄면 R은 아무 일도 하지 않습니다. A+B는 켜든 끄든 항상 L입니다. ※ 아직 만드는 중입니다 - 지금은 카에데의 앞굴리기+베기 하나만 나갑니다.",
      NULL,
      "system",
      {
         { "enabled",  "켬" },
   ...
   },
   {
      ...
      NULL,
      "더 킹 오브 파이터즈 R-2 전용. 켜면 R가 기술키가 됩니다 - 방향+R 로 필살기가 나갑니다(짧게 누르면 약, 길게 누르면 강). 방향 없이=장풍, 앞=대공, 뒤/아래/뒤아래=각각 다른 기술, 앞아래=초필살기, 공중에서도 나갑니다. B/A 는 그대로 펀치/킥이고 홀드하면 강입니다. 끄면 R은 아무 일도 하지 않습니다. A+B는 켜든 끄든 항상 L입니다.",
      NULL,
      "system",
      {
         { "enabled",  "켬" },
