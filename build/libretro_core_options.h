...
struct retro_core_option_v2_definition option_defs_us_v2[] = {
   ...
   },
   {
      ...
      NULL,
      "월화의 검사 전용. R(SP)+방향=필살기, R+A=초필, R+B=잠재오의, R+A+B=기 모드 난무오의 시작. A/B는 게임의 베기/발차기 버튼입니다. 지원하는 기술 도중 R을 다시 누르면 파생기가 나갑니다. 방향으로 파생 선택, 길게 누르면 버튼 유지. 게이지·체력·속성·거리 조건은 원작대로입니다. 끄면 R=A+B, L은 항상 A+B입니다.",
      NULL,
      "system",
      {
         { "enabled",  "켬" },
   ...
   },
   {
      ...
      NULL,
      "KOF R-2 전용. R(SP)+방향=기존 필살기, 앞아래+R 또는 R+펀치=캐릭터별 초필1, R+킥=초필2, R+펀치+킥=초필3(있는 캐릭터). 레오나·아테나는 공중 초필 지원. 지원하는 기술 도중 R 재입력=파생기. 짧게 약, 길게 강. 원작의 게이지·거리 조건이 필요합니다. 끄면 R=A+B, L은 항상 A+B입니다.",
      NULL,
      "system",
      {
         { "enabled",  "켬" },
   ...
   },
   {
      ...
      "SvC 강 발동 당김",
      NULL,
      "강약 구분 끔(2버튼)에서 A/B 를 꾹 눌러 내는 강이 언제 시작하는지. 게임은 문턱에 닿고도 2프레임을 더 끄는데 그 슬랙을 돌려받는 것입니다. 쥐는 시간(8프레임)도 강 모션 길이(캐릭터별)도 그대로입니다. 보통 = 2프레임 당김, 약으로 남는 탭 6프레임 유지. 최대 = 4프레임 당김, 약 탭이 4프레임으로 줄어듭니다. 강 자체가 굼뜬 캐릭터는 「빠른 기본기(FastCD)」가 모션을 줄입니다. (SNK vs. Capcom MotM 전용)",
      NULL,
      "system",
      {
         { "mid", "보통 (약 창 유지)" },
