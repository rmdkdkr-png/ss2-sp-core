...
struct retro_core_option_v2_definition option_defs_us_v2[] = {
   ...
   },
   {
      ...
      "SS2 Character Chat",
      NULL,
      "Samurai Shodown! 2 only. The commentator character's lines (relationship banter, KO/perfect/comeback remarks, menu chatter). Off keeps only the referee (Kuroko). Default off.",
      NULL,
      "video",
      {
         { "enabled",  "Enabled" },
   ...
   },
   {
      ...
      "SS2 Referee (Kuroko)",
      NULL,
      "Samurai Shodown! 2 only. The referee calls the match: fighter names, round start, decision. Voice comes from the Korean voice pack when installed. Independent of Character Chat.",
      NULL,
      "video",
      {
         { "enabled",  "Enabled" },
