...
struct retro_core_option_v2_definition option_defs_us_v2[] = {
   ...
   },
   {
      ...
      NULL,
      "월화의 검사(The Last Blade) 전용. 숨김 캐릭터와 각성 카에데를 포함한 전 캐릭터의 지상 SP를 지원합니다. R+방향으로 기술 선택, 리·잔테츠·카가미는 공중 SP도 지원합니다. 끄면 R은 A+B, L은 항상 A+B입니다.",
      NULL,
      "system",
      {
         { "enabled",  "켬" },
   ...
   },
   {
      ...
      NULL,
      "더 킹 오브 파이터즈 R-2 전용. 켜면 R가 기술키가 됩니다 - 방향+R 로 필살기가 나갑니다(짧게 누르면 약, 길게 누르면 강). 방향 없이=장풍, 앞=대공, 뒤/아래/뒤아래=각각 다른 기술, 앞아래=초필살기, 공중에서도 나갑니다. B/A 는 그대로 펀치/킥이고 홀드하면 강입니다. 끄면 R은 A+B로 동작합니다. A+B는 켜든 끄든 항상 L로도 낼 수 있습니다.",
      NULL,
      "system",
      {
         { "enabled",  "켬" },
