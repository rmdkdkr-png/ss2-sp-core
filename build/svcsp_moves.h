...
static const svc_move mv_c0[] = {
  {"외식 굉부양 (Goufu You)", mo_c0_0, 1, 0x20, 0},
  {"88식", mo_c0_1, 1, 0x20, 0},
  {"외식 나락 떨구기 (Naraku Otoshi)", mo_c0_2, 1, 0x10, 4},
  {"114식 황물기 (Aragami)", mo_c0_3, 3, 0x10, 0},
  {"115식 독물기 (Dokugami)", mo_c0_4, 3, 0x10, 0},
  {"128식 구상 (Kono Kizu)", mo_c0_5, 3, 0x10, 0},
  {"127식 팔청 (Yano Sabi)", mo_c0_6, 5, 0x10, 0},
  {"401식 죄읊기 (Tsumi Yomi)", mo_c0_7, 5, 0x10, 0},
  {"100식 귀신태우기 (Oniyaki)", mo_c0_8, 3, 0x10, 0},
  {"R.E.D. 킥", mo_c0_9, 3, 0x20, 0},
  {"75식 개", mo_c0_10, 3, 0x20, 0},
  {"212식 금월양 (Kototsuki You)", mo_c0_11, 5, 0x20, 0},
  {"910식 누에잡기 (Nue Tsumi)", mo_c0_12, 3, 0x10, 0},
  {"이면 108식 대사치 (Orochinagi)", mo_c0_13, 7, 0x10, 0},
  {"최종결전오의 무식", mo_c0_14, 6, 0x10, 0},
  {"182식", mo_c0_15, 6, 0x20, 0},
};
...
static const svc_move mv_c1[] = {
  ...
  {"백스핀 킥", mo_c1_1, 1, 0x20, 0},
  {"파워 웨이브", mo_c1_2, 3, 0x10, 0},
  {"라이징 태클", mo_c1_3, 2, 0x10, 16},
  {"크랙 슛", mo_c1_4, 3, 0x20, 0},
  {"번 너클", mo_c1_5, 3, 0x10, 0},
  {"파워 덩크", mo_c1_6, 3, 0x20, 0},
  {"파이어 킥", mo_c1_7, 5, 0x20, 0},
  {"파워 가이저", mo_c1_8, 7, 0x10, 0},
  {"하이 앵글 가이저", mo_c1_9, 6, 0x20, 0},
};
...
static const svc_move mv_c2[] = {
  ...
  {"호포", mo_c2_3, 3, 0x10, 0},
  {"비연질풍각", mo_c2_4, 5, 0x20, 0},
  {"잔렬권", mo_c2_5, 3, 0x10, 0},
  {"패왕상후권", mo_c2_6, 6, 0x10, 0},
  {"용호난무", mo_c2_7, 7, 0x10, 0},
  {"천지패황권", mo_c2_8, 6, 0x10, 0},
};
...
static const svc_move mv_c3[] = {
  {"홍학의 춤 (Benitsuru no Mai)", mo_c3_0, 1, 0x20, 0},
  {"흑연의 춤 (Koku'en no Mai)", mo_c3_1, 1, 0x20, 0},
  {"대륜풍차떨구기", mo_c3_2, 1, 0x10, 4},
  {"화접선", mo_c3_3, 3, 0x10, 0},
  {"용염무", mo_c3_4, 3, 0x10, 0},
  {"사치요 도리 (小夜千鳥)", mo_c3_5, 3, 0x20, 0},
  {"필살인봉", mo_c3_6, 5, 0x20, 0},
  {"무사사비의 춤 (지상)", mo_c3_7, 2, 0x10, 16},
  {"무사사비의 춤 (공중)", mo_c3_8, 3, 0x10, 4},
  {"초필살인봉", mo_c3_9, 7, 0x20, 0},
  {"화람 (Hana Arashi)", mo_c3_10, 6, 0x10, 0},
...
static const svc_move mv_c4[] = {
  {"스트라이크 아치", mo_c4_0, 1, 0x20, 0},
  {"발틱 런처", mo_c4_1, 2, 0x10, 16},
  {"그라운드 세이버", mo_c4_2, 2, 0x20, 16},
  {"문 슬래셔", mo_c4_3, 2, 0x10, 16},
  {"아이 슬래셔", mo_c4_4, 3, 0x10, 0},
  {"X 칼리버", mo_c4_5, 3, 0x10, 4},
  {"이어링 폭탄", mo_c4_6, 3, 0x20, 0},
  {"V 슬래셔", mo_c4_7, 7, 0x10, 4},
  {"리벨 스파크", mo_c4_8, 7, 0x20, 0},
  {"그래비티 스톰", mo_c4_9, 6, 0x10, 0},
  {"그레이트풀 데드", mo_c4_10, 6, 0x20, 0},
};
...
static const svc_move mv_c5[] = {
  {"연환퇴", mo_c5_0, 1, 0x20, 0},
  {"피닉스 밤", mo_c5_1, 1, 0x20, 4},
  {"사이코 볼", mo_c5_2, 3, 0x10, 0},
  {"사이코 소드", mo_c5_3, 3, 0x10, 0},
  {"피닉스 애로우", mo_c5_4, 3, 0x20, 4},
  {"사이코 리플렉터", mo_c5_5, 5, 0x20, 0},
  {"뉴(ν) 사이코 리플렉터", mo_c5_6, 5, 0x20, 0},
  {"사이킥 텔레포트", mo_c5_7, 3, 0x20, 0},
  {"슈퍼 사이킥 스로우", mo_c5_8, 5, 0x10, 1},
  {"샤이닝 크리스탈 비트", mo_c5_9, 10, 0x10, 0},
  {"피닉스 팽 애로우", mo_c5_10, 6, 0x20, 4},
...
static const svc_move mv_c6[] = {
  ...
  {"외식 굉부음 '사신'", mo_c6_1, 1, 0x20, 0},
  {"외식 유리오리 (백합꺾기)", mo_c6_2, 1, 0x20, 4},
  {"108식 야미바라이 (어둠쫓기)", mo_c6_3, 3, 0x10, 0},
  {"100식 오니야키", mo_c6_4, 3, 0x10, 0},
  {"127식 아오이하나", mo_c6_5, 3, 0x10, 0},
  {"212식 코토츠키 인", mo_c6_6, 5, 0x20, 0},
  {"311식 츠마구시", mo_c6_7, 3, 0x20, 0},
  {"쿠즈카제", mo_c6_8, 6, 0x10, 1},
  {"금 1211식 야오토메 (팔치녀)", mo_c6_9, 7, 0x10, 0},
  {"이면 108식 야사카즈키", mo_c6_10, 7, 0x10, 0},
  {"이면 311식 사쿠 츠마구시", mo_c6_11, 6, 0x20, 0},
};
...
static const svc_move mv_c9[] = {
  ...
  {"선풍각(Senpukyaku)", mo_c9_1, 1, 0x20, 0},
  {"파동권(Hadouken)", mo_c9_2, 3, 0x10, 0},
  {"작열 파동권(Shakunetsu Hadouken)", mo_c9_3, 5, 0x10, 0},
  {"승룡권(Shoryuken)", mo_c9_4, 3, 0x10, 0},
  {"용권선풍각(Tatsumaki Senpukyaku)", mo_c9_5, 3, 0x20, 0},
  {"진공파동권(Shinku Hadouken)", mo_c9_6, 6, 0x10, 0},
  {"진공용권선풍각(Shinku Tatsumaki Senpukyaku)", mo_c9_7, 6, 0x20, 0},
  {"진 승룡권(Shin Shoryuken)", mo_c9_8, 6, 0x20, 0},
};
...
static const svc_move mv_c10[] = {
  ...
  {"후방회전각(Kouhou Kaiten Kyaku)", mo_c10_1, 1, 0x20, 0},
  {"응조각(Yousou Kyaku)", mo_c10_2, 1, 0x20, 4},
  {"기공권(Kikoken)", mo_c10_3, 5, 0x10, 0},
  {"천승각(Tenshokyaku)", mo_c10_4, 2, 0x20, 16},
  {"스피닝 버드 킥(Spinning Bird Kick)", mo_c10_5, 2, 0x20, 16},
  {"선원추(Sen'enshu)", mo_c10_6, 5, 0x20, 0},
  {"기공장(Kikosho)", mo_c10_7, 6, 0x10, 0},
  {"천렬각(Senretsukyaku)", mo_c10_8, 4, 0x20, 16},
  {"패산천승각(Hazan Tenshokyaku)", mo_c10_9, 4, 0x20, 16},
  {"칠성섬공각(Shichisei Senkukyaku)", mo_c10_10, 6, 0x20, 4},
};
...
static const svc_move mv_c11[] = {
  ...
  {"다이너마이트 킥(Dynamite Kick)", mo_c11_1, 1, 0x20, 0},
  {"플라잉 바디 프레스(Flying Body Press)", mo_c11_2, 1, 0x10, 4},
  {"더블 니 드롭(Double Knee Drop)", mo_c11_3, 1, 0x20, 4},
  {"공중 헤드벗(Midair Headbutt)", mo_c11_4, 1, 0x10, 4},
  {"더블 라리아트(Double Lariat)", mo_c11_5, 3, 0x10, 0},
  {"퀵 더블 라리아트(Quick Double Lariat)", mo_c11_6, 3, 0x20, 0},
  {"배니싱 플랫(Banishing Flat)", mo_c11_7, 3, 0x10, 0},
  {"스크류 파일 드라이버(Screw Piledriver)", mo_c11_8, 6, 0x10, 1},
  {"아토믹 수플렉스(Atomic Suplex)", mo_c11_9, 6, 0x20, 1},
  {"플라잉 파워밤(Flying Powerbomb)", mo_c11_10, 6, 0x20, 0},
  {"파이널 아토믹 버스터(Final Atomic Buster)", mo_c11_11, 6, 0x10, 1},
  {"에어리얼 러시안 슬램(Aerial Russian Slam)", mo_c11_12, 6, 0x20, 0},
  {"러시안 비트(Russian Beat)", mo_c11_13, 6, 0x20, 0},
};
...
static const svc_move mv_c12[] = {
  ...
  {"우시로 마와시 게리(Ushiro Mawashi Geri)", mo_c12_1, 1, 0x20, 0},
  {"전방전신(Zenpou Tenshin)", mo_c12_2, 3, 0x10, 0},
  {"파동권(Hadouken)", mo_c12_3, 3, 0x10, 0},
  {"승룡권(Shoryuken)", mo_c12_4, 3, 0x10, 0},
  {"용권선풍각(Tatsumaki Senpukyaku)", mo_c12_5, 3, 0x20, 0},
  {"승룡열파(Shoryu Reppa)", mo_c12_6, 5, 0x10, 0},
  {"신룡권(Shinryuken)", mo_c12_7, 6, 0x20, 0},
  {"질풍신뢰각(Shippu Jinraikyaku)", mo_c12_8, 6, 0x20, 0},
};
...
static const svc_move mv_c13[] = {
  ...
  {"단공각(Dankukyaku)", mo_c13_2, 3, 0x20, 0},
  {"진공아도권(Shinku Gadouken)", mo_c13_3, 6, 0x10, 0},
  {"코류렉카(Kouryu Rekka)", mo_c13_4, 5, 0x20, 0},
  {"필승무뢰권(Hisshou Burai Ken)", mo_c13_5, 6, 0x20, 0},
...
static const svc_move mv_c14[] = {
  {"플라워 킥(Flower Kick)", mo_c14_0, 1, 0x20, 0},
  {"파동권(Hadouken)", mo_c14_1, 3, 0x10, 0},
  {"쇼오켄(Shououken)", mo_c14_2, 3, 0x10, 0},
  {"춘풍각(Shunpukyaku)", mo_c14_3, 3, 0x20, 0},
  {"사쿠라 오토시(Sakura Otoshi)", mo_c14_4, 3, 0x20, 0},
  {"진공파동권(Shinku Hadouken)", mo_c14_5, 6, 0x10, 0},
  {"미다레자쿠라(Midare Zakura)", mo_c14_6, 5, 0x20, 0},
  {"하루이치방(Haru Ichiban)", mo_c14_7, 6, 0x20, 0},
...
static const svc_move mv_c15[] = {
  {"셸 킥(Shell Kick)", mo_c15_0, 1, 0x20, 4},
  ...
  {"피니싱 샤워(Finishing Shower)", mo_c15_5, 6, 0x20, 0},
  {"발키리 턴(Valkyrie Turn)", mo_c15_6, 5, 0x20, 0},
...
static const svc_move mv_c16[] = {
  ...
  {"델타 킥(Delta Kick)", mo_c16_2, 3, 0x20, 0},
  {"헬 캣(Hell Cat)", mo_c16_3, 5, 0x20, 1},
  {"캣 클린치(Cat Clinch/Fake Throw)", mo_c16_4, 1, 0x10, 1},
  {"댄싱 플래시(Dancing Flash)", mo_c16_5, 6, 0x10, 0},
  {"플리즈 헬프 미(Please Help Me)", mo_c16_6, 6, 0x10, 0},
  {"ES 롤링 스크래치(ES Rolling Scratch)", mo_c16_7, 6, 0x20, 0},
};
...
static const svc_move mv_c17[] = {
  ...
  {"리버스 스핀 킥(Reverse Spin Kick)", mo_c17_1, 1, 0x20, 0},
  {"소닉 붐(Sonic Boom)", mo_c17_2, 2, 0x10, 16},
  {"서머솔트 킥(Somersault Kick)", mo_c17_3, 2, 0x20, 16},
  {"소닉 허리케인(Sonic Hurricane)", mo_c17_4, 4, 0x10, 24},
  {"서머솔트 스트라이크(Somersault Strike)", mo_c17_5, 4, 0x20, 16},
