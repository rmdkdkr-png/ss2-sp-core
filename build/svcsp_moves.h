...
typedef struct { const svc_move *mv; unsigned char n; const char *name; signed char slots[7]; } svc_chartab;
#define SVC_CHAR_COUNT 18
static const svc_chartab svc_chars[SVC_CHAR_COUNT] = {
  { mv_c0, 18, "쿄", {3,14,12,8,9,11,2} },
  { mv_c1, 10, "테리", {2,8,5,3,6,4,-1} },
  { mv_c2, 9, "료", {1,7,5,3,4,6,1} },
  { mv_c3, 12, "마이", {3,6,5,4,7,6,8} },
  { mv_c4, 11, "레오나", {1,9,6,3,4,2,5} },
  { mv_c5, 12, "아테나", {2,9,8,3,5,7,3} },
  { mv_c6, 12, "이오리", {3,9,5,4,7,6,2} },
  { mv_c7, 5, "하오마루", {0,3,2,1,-1,4,-1} },
  { mv_c8, 8, "나코루루", {4,3,1,2,3,5,0} },
  { mv_c9, 9, "류", {2,6,0,4,5,3,5} },
  { mv_c10, 11, "춘리", {3,7,-1,4,0,5,2} },
  { mv_c11, 14, "장기에프", {7,11,8,5,12,6,2} },
  { mv_c12, 9, "켄", {3,6,2,4,7,5,5} },
  { mv_c13, 7, "단", {0,3,2,1,4,5,2} },
  { mv_c14, 9, "사쿠라", {1,5,3,2,6,4,3} },
  { mv_c15, 8, "모리간", {1,4,3,2,5,6,1} },
  { mv_c16, 8, "펠리시아", {0,5,3,2,1,6,-1} },
  { mv_c17, 7, "가일", {2,4,0,3,5,6,-1} },
};
